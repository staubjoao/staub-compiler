...
%type <nd_obj> datatype else body body_statement statement_class statement condition return relop atributs_method parament_method class_call class_call_aux params_const param_const init_vector
